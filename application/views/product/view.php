    ...
    <section class="content">
        <div class="container">
            <div class="content-body">
                <h1 class="f9 m0 mB30 title-effect" data-text="<?= htmlspecialchars($product->title) ?>">
                    <?= $product->title ?>
                    <br>
                     
                </h1>
                <?php if (! empty($product->image)): ?>
                    <img src="<?= uploadPath($product->image, 'product/normal') ?>" style="margin: 0 15px 15px 0;" width="305"
                         alt="<?= htmlspecialchars($product->title) ?>" align="left" class="img-responsive">
                <?php endif; ?>
                <?= $product->detail ?>
            ...
            <div class="w100 clearfix">
                ...
                <div class="share-box clearfix">
                    ...
                    <a class="btnShare twitter"
                       href="https://twitter.com/share?url=<?php echo current_url() ?>&text=<?php echo htmlspecialchars($product->title) ?>"
