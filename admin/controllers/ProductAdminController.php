...
class ProductAdminController extends Manager
{
    ...
    protected function insertAfterValidate()
    {
        $this->utils
            ...
            ->minSizes(800, 600)
            ->addProcessSize('thumb', 400, 300, 'product/thumb', 'thumbnail')
            ->addProcessSize('fit', 800, 600, 'product/normal', 'thumbnail')
            ->addProcessSize('normal', null, 1024, 'product/fit', 'fit-height');
    ...
    public function imageInsert()
    {
        ...
        $this->utils
            ...
            ->uploadInput('file')
            ->minSizes(800, 600)
            ->addProcessSize('thumb', null, 200, 'product/thumb', 'fit-height')
            ->addProcessSize('fit', 800, 600, 'product/normal', 'thumbnail')
            ->addProcessSize('normal', null, 1024, 'product/fit', 'fit-height');
    ...
    public function imageUpdate()
    {
        ...
        if ($this->input->post()) {
            ...
            $this->utils
                ->uploadInput('imageFile')
                ->minSizes(800, 600)
                ->addProcessSize('thumb', null, 250, 'product/thumb', 'fit-height')
                ->addProcessSize('fit', 800, 600, 'product/normal', 'thumbnail')
                ->addProcessSize('normal', null, 1024, 'product/fit', 'fit-height');
