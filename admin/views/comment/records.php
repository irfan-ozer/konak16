...
<div class="panel panel-default">
    ...
    <table class="table table-bordered table-hover">
        ...
        <tr>
            ...
            <th width="100" class="text-center">Yayınla</th>
        ...
        <tr>
            ...
            <td class="text-center"><a class="btn btn-<?php echo $item->approved == 1 ? 'success':'default' ?> btn-xs" href="<?= $this->module.'/approve/'.$item->id ?>"><i class="fa fa-check"></i> </a> </td>
            <td class="text-right">
