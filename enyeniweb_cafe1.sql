...
--
-- Anamakine: localhost
-- Üretim Zamanı: 28 Kas 2017, 13:16:52
...
(4, 1, NULL, 'İletişim', 'İLETİŞİM', '@contact', '', '', '_self', 9, 'tr'),
(6, 1, NULL, 'Hizmetlerimiz', 'HİZMETLERİMİZ', '@service', '', '', '_self', 3, 'tr'),
...
(36, 1, NULL, 'Galeri', 'GALERİ', '@gallery/kuruyemis/2', '', '', '_self', 6, 'tr'),
...
(41, 1, NULL, 'Hediyelik Eşya', 'Hediyelik Eşya', '@productcategory/hediyelik-esya/12', '', '', '_self', 4, 'tr'),
(43, 41, NULL, 'Çikolata Çeşitleri', 'Çikolata Çeşitleri', '@productcategory/cikolata-cesitleri/13', NULL, NULL, NULL, 1, 'tr'),
(44, 41, NULL, 'HEDİYELİK EŞYA', 'HEDİYELİK EŞYA', '@productcategory/hediyelik-esya/12', NULL, NULL, NULL, 2, 'tr');
...
(13, 'contact', 'googleMap', 'Google Map Kordinatları', '', 'text', '[]', 'tr'),
(14, 'contact', 'googleMapText', 'Google Map Yazısı', 'Cafe Sitesi', 'text', '[]', 'tr'),
(15, 'contact', 'detail', 'İletişim Bilgileri', '<p><b>CAFE</b></p>\n\n<p>Demirtaşpaşa Mahallesi Celal Bayar Cad. A.Fikri Bozkaya &Ouml;rkap İş Merkezi No:12 K:5 D:39-40 Osmangazi / BURSA</p>\n\n<p><span style="line-height: 1.42857;">Tel :&nbsp;0 554 526 62 31</span></p>\n\n<p><span style="line-height: 1.42857;">Tel :&nbsp;</span>0 224 251 77 77</p>\n\n<p>E-Posta : info@enyeniweb.com</p>\n\n<p>&nbsp;</p>\n', 'editor', '{"required":true}', 'tr'),
...
(26, 'contact', 'address', 'Adres', 'Demirtaşpaşa Mahallesi Celal Bayar Cad. A.Fikri Bozkaya Örkap İş Merkezi No:12 K:5 D:39-40 Osmangazi / BURSA', 'text', '[]', 'tr'),
(27, 'contact', 'phone', 'Telefon Numarası', '0554 526 62 31', 'text', '[]', 'tr'),
(28, 'contact', 'mail', 'Email Adresi', 'info@enyeniweb.com', 'text', '[]', 'tr'),
...
(1, 'metaTitle', 'Site Başlığı', 'Cafe | Kahve | Cafe Sitesi | Kahveci Sitesi |Kuruyemişçi | En Yeni Web', 'text', '{"required":true}', 'tr'),
(2, 'metaDescription', 'Site Tanımı', 'Cafe | Kahve | Cafe Sitesi | Kahveci Sitesi |Kuruyemişçi | En Yeni Web', 'textarea', '{"required":true}', 'tr'),
(3, 'metaKeywords', 'Site Anahtar Kelimeleri', 'Cafe | Kahve | Cafe Sitesi | Kahveci Sitesi |Kuruyemişçi | En Yeni Web', 'textarea', '{"required":true}', 'tr'),
...
(9, 'footerText', 'Footer Kısa Yazı', '<h2>Cafe / Kahve Şehri </h2><br>', 'textarea', '[]', NULL);
...
(3, 12, 'Çikolataaaa', 'cikolataaaa', '2e1a467387dd289b78298835288b74cf.jpg', 'özet çikolataaaaaözet çikolataaaaaözet çikolataaaaaözet çikolataaaaaözet çikolataaaaaözet çikolataaaaaözet çikolataaaaa', '<p>a&ccedil;ıklama &ccedil;ikolataaaa&nbsp;a&ccedil;ıklama &ccedil;ikolataaaa&nbsp;a&ccedil;ıklama &ccedil;ikolataaaa&nbsp;a&ccedil;ıklama &ccedil;ikolataaaa&nbsp;a&ccedil;ıklama &ccedil;ikolataaaa&nbsp;a&ccedil;ıklama &ccedil;ikolataaaa&nbsp;a&ccedil;ıklama &ccedil;ikolataaaa&nbsp;a&ccedil;ıklama &ccedil;ikolataaaa&nbsp;</p>\n', '', '', '', 2, 'tr'),
(4, 13, 'Bitter Çikolata', 'bitter-cikolata', '5c4c14e044ed19ec349b81768e3abdae.jpg', 'özet bitter çikolataaaözet bitter çikolataaaözet bitter çikolataaaözet bitter çikolataaaözet bitter çikolataaaözet bitter çikolataaaözet bitter çikolataaaözet bitter çikolataaa', '<p>a&ccedil;ıklama bitter &ccedil;ikolata&nbsp;a&ccedil;ıklama bitter &ccedil;ikolata&nbsp;a&ccedil;ıklama bitter &ccedil;ikolata&nbsp;a&ccedil;ıklama bitter &ccedil;ikolata&nbsp;a&ccedil;ıklama bitter &ccedil;ikolata&nbsp;a&ccedil;ıklama bitter &ccedil;ikolata&nbsp;a&ccedil;ıklama bitter &ccedil;ikolata&nbsp;</p>\n', '', '', '', 3, 'tr');
...
(13, 0, 'Çikolata Çeşitleri', 'cikolata-cesitleri', 'özet çikolata çeşitleriözet çikolata çeşitleriözet çikolata çeşitleriözet çikolata çeşitleriözet çikolata çeşitleriözet çikolata çeşitleriözet çikolata çeşitleri', '<p>detay &ccedil;ikolata &ccedil;eşitleridetay &ccedil;ikolata &ccedil;eşitleridetay &ccedil;ikolata &ccedil;eşitleridetay &ccedil;ikolata &ccedil;eşitleridetay &ccedil;ikolata &ccedil;eşitleridetay &ccedil;ikolata &ccedil;eşitleridetay &ccedil;ikolata &ccedil;eşitleri</p>\n', 'ee82028ca0eb811c119e682829926193.jpg', '', '', '', 0, 'tr');
...
(5, 'Kahve Çeşitleri', 'kahve-cesitleri', 'özet kahve çeşitleriözet kahve çeşitleriözet kahve çeşitleriözet kahve çeşitleriözet kahve çeşitleriözet kahve çeşitleriözet kahve çeşitleriözet kahve çeşitleri', '<p>detay kahve &ccedil;eşitleridetay kahve &ccedil;eşitleridetay kahve &ccedil;eşitleridetay kahve &ccedil;eşitleridetay kahve &ccedil;eşitleridetay kahve &ccedil;eşitleridetay kahve &ccedil;eşitleridetay kahve &ccedil;eşitleridetay kahve &ccedil;eşitleridetay kahve &ccedil;eşitleri</p>\n\n<p>&nbsp;</p>\n\n<p><img alt="" src="public/upload/editor/images/iStock_99048315_XLARGE.jpg" style="width: 1600px; height: 1067px;" /></p>\n', 'ac864345a77d85a5a9dccedd0535771f.jpg', '', '', '', 5, 'tr');
...
(1, 'Facebook', 'https://www.facebook.com/profile.php?id=100011025581508', NULL, 'fa fa-facebook', 1),
(2, 'Twitter', 'https://twitter.com/EnYeniWeb', NULL, 'fa fa-twitter', 3),
(3, 'Instagram', 'https://www.instagram.com/enyeniweb/?hl=tr', 'b346e243a2a725df832e932a6d958670.jpg', 'fa fa-instagram', 2);
